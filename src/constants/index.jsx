...
export const HERO_CONTENT =`I have over 10 years of experience in the IT industry, specializing in developing enterprise applications using IBM FileNet suite of products,IBM BAW, Java/J2EE specifications, and deploying them on industry-standard application servers like WebSphere. My extensive experience includes creating solutions for content and workflow management using IBM FileNet products such as Business Process Manager, Content Manager, IBM Content Navigator,IBM Case Manager v5.2 and IBM BAW. I have been heavily involved in the creation of document classes, custom objects, properties, events, and subscriptions.`;
