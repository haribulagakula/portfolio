...
export const HERO_CONTENT =`As a prospective Engineering Management graduate with a proven track record in the Software industry, I thrive in making informed 
...
has equipped me with the skills and knowledge to lead and deliver complex projects within a budget on a given time horizon. I am specialized in developing enterprise applications using IBM FileNet suite of products, Java/J2EE specifications, and deploying them on industry-standard application servers like WebSphere. My extensive experience includes creating solutions for content and workflow management using IBM FileNet products such as Business Process Manager, Content Manager, IBM Content Navigator,IBM Case Manager v5.2 and IBM BAW.`;
